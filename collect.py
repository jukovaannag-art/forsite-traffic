...
Запускается каждые 10 минут в окне 7:00-23:00 по Иркутску: прогон GitHub
Actions держится в эфире несколько часов и дёргает этот скрипт по кругу
(см. .github/workflows/collect.yml). Локально: python collect.py
